...
var ACTION_ROLE_MAP = {
  ...
  'maintenance.laporan.submit': ['SUPER_ADMIN', 'ADMIN', 'AM', 'GS1', 'USER', 'DRIVER', 'MECHANIC'],
  'maintenance.report.list': ['SUPER_ADMIN', 'ADMIN', 'AM', 'GS1', 'VENDOR_BENGKEL', 'MECHANIC', 'USER', 'DRIVER'],
  'maintenance.laporan.list': ['SUPER_ADMIN', 'ADMIN', 'AM', 'GS1', 'VENDOR_BENGKEL', 'MECHANIC', 'USER', 'DRIVER'],
  'maintenance.report.update': ['SUPER_ADMIN', 'ADMIN', 'AM', 'GS1', 'VENDOR_BENGKEL', 'MECHANIC'],
  'maintenance.laporan.update': ['SUPER_ADMIN', 'ADMIN', 'AM', 'GS1', 'VENDOR_BENGKEL', 'MECHANIC'],
  'maintenance.harsat.list': ['SUPER_ADMIN', 'ADMIN', 'AM', 'GS1', 'VENDOR_BENGKEL', 'MECHANIC', 'USER'],
  'maintenance.harsat.create': ['SUPER_ADMIN', 'ADMIN', 'GS1'],
  'maintenance.harsat.update': ['SUPER_ADMIN', 'ADMIN', 'GS1'],
  'maintenance.harsat.delete': ['SUPER_ADMIN', 'ADMIN', 'GS1'],
  'maintenance.vehicles.list': ['SUPER_ADMIN', 'ADMIN', 'AM', 'GS1', 'VENDOR_BENGKEL', 'MECHANIC', 'USER', 'DRIVER'],
  'maintenance.vehicles.create': ['SUPER_ADMIN', 'ADMIN', 'GS1'],
  'maintenance.vehicles.update': ['SUPER_ADMIN', 'ADMIN', 'GS1', 'MECHANIC'],
  'maintenance.rab.submit': ['SUPER_ADMIN', 'ADMIN', 'AM', 'GS1', 'VENDOR_BENGKEL'],
  'maintenance.rab.list': ['SUPER_ADMIN', 'ADMIN', 'AM', 'GS1', 'VENDOR_BENGKEL', 'MECHANIC'],
  'maintenance.spk.create': ['SUPER_ADMIN', 'ADMIN', 'AM'],
  'maintenance.spk.list': ['SUPER_ADMIN', 'ADMIN', 'AM', 'GS1', 'VENDOR_BENGKEL', 'MECHANIC'],
  'maintenance.summary.get': ['SUPER_ADMIN', 'ADMIN', 'AM', 'GS1'],
  'maintenance.resume.get': ['SUPER_ADMIN', 'ADMIN', 'AM', 'GS1'],
  'maintenance.document.upload': ['SUPER_ADMIN', 'ADMIN', 'AM', 'GS1', 'USER', 'DRIVER', 'MECHANIC', 'VENDOR_BENGKEL'],
  'maintenance.pdf.generate': ['SUPER_ADMIN', 'ADMIN', 'AM', 'GS1', 'VENDOR_BENGKEL', 'MECHANIC'],
  'maintenance.users.list': ['SUPER_ADMIN', 'ADMIN'],
  'maintenance.users.toggle': ['SUPER_ADMIN', 'ADMIN'],
